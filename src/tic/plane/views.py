...
from .forms import PlaneEventForm, ChooseSeatForm, SeatingPlanCreateForm, ButtonForm
...
class CreateSeatingPlanView(FormView):
	...
	success_url = reverse_lazy("list_plane_event")
	...
	def form_valid(self, form):
		...
		for i in range(1, num_of_seats+1):
			...
			event.planeticket_set.create(price=price, seat=seat)
